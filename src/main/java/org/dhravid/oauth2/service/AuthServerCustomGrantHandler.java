...
public class AuthServerCustomGrantHandler extends AbstractTokenGranter 
{
	...
	public AuthServerCustomGrantHandler(AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService,	OAuth2RequestFactory requestFactory, String grantType) 
	{
